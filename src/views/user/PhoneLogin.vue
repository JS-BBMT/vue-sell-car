<template>
    <div class=" sm:mt-28 lg:mt-28 mt-28 bg-primary-500 dark:bg-primaryDark-accent  h-screen flex flex-col">
        ...
        <div class=" mt-56 w-96 flex flex-col mx-auto bg-background dark:bg-backgroundDark  m-auto rounded-lg">
            ...
            <ps-input class="mt-2 mx-8" type="text" v-bind:placeholder="$t('phone_login__phone_number_placeholder')" v-bind:value="$t('country_code')" v-on:keyup.enter="clicked" @keypress="validatePhone" v-model:value="phone"></ps-input>
