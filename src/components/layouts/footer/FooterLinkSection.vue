            ...
            <div class="grid sm:grid-cols-12 grid-cols-4  gap-4 sm:gap-3.5 lg:gap-4 text-textLight mt-8" >
                <div class="sm:col-span-8 col-span-4 grid grid-cols-4 sm:grid-cols-6 lg:grid-cols-8 gap-4 sm:gap-3.5 lg:gap-4">
                    <div class="col-start-2 sm:col-start-1 col-span-2 mb-6">
                        <ps-label class="font-medium mb-4 lg:text-2xl text-xl" textColor="text-textLight" textSize="font-light lg:text-sm text-xs"> Services </ps-label>
                         
                        <ps-label class="mt-2 font-light lg:text-sm text-xs cursor-pointer" textColor="text-textLight" textSize="font-light lg:text-sm text-xs"> 
                            <a href="https://yard99.in/forms/insurance">Insurance </a>                                        
 
                        </ps-label>


                        <ps-label class="mt-2 font-light lg:text-sm text-xs cursor-pointer" textColor="text-textLight" textSize="font-light lg:text-sm text-xs"> 
                            <a href="https://yard99.in/forms/finance">Finance</a>                                        
                        ...
                        <ps-label class="mt-2 font-light lg:text-sm text-xs cursor-pointer" textColor="text-textLight" textSize="font-light lg:text-sm text-xs"> 
                            <a href="https://yard99.in/forms/rto"> RTO</a>                                        
                ...
                <div class="col-span-4 grid grid-cols-4 gap-4 sm:gap-3.5 lg:gap-4">
                    ...
                    <ps-label v-if="appInfoProvider?.appInfo?.data?.frontendConfigSetting?.googleSetting == '1'" class="sm:col-start-1 col-start-2 col-span-2 mt-2" >
                    ...
                    <ps-label  v-if="appInfoProvider?.appInfo?.data?.frontendConfigSetting?.appStoreSetting == '1'" class="sm:col-start-3 col-start-2 col-span-2 mt-2" >
