<template>
   <div v-if="psValueHolder.isUserLoggedIn()"></div>
        ...
        <div class="flex justify-between items-center content-center my-auto w-mobile sm:w-median lg:w-large mx-auto">
            ...
            <div class="items-center content-center hidden sm:flex ">
                ...
                <div v-else class="flex flex-row">
                    ...
                    <div class="flex flex-row mt-1 me-1">

                    <ps-dropdown align="right" h="h-56" class=' z-50' >
                        <template #select >
                            <ps-label class=" h-full" @click='userNameClicked'>
                                ...
                                <button
                                    ...
                                    <ps-label class="ms-2 text-secondary-400 font-medium"  > Services </ps-label>                                    
                                    <ps-icon textColor="text-secondary-400 dark:text-secondaryDark-grey" name="downArrow"  w='25' h='25' class=""  />
                        ...
                        <template #list >
                            <div
                                ...
                                <div class="pt-2 z-30 absolute">
                                    ...
                                    <div class="w-56 py-4 px-2 hover:bg-primary-000 dark:hover:bg-primaryDark-black cursor-pointer items-center"  >
                                           <a href="https://yard99.in/forms/insurance"> <ps-label class="ms-2 text-secondary-500 font-medium"  > Insurance </ps-label></a>                                        
                                        </div>


                                        <div class="w-56 py-4 px-2 hover:bg-primary-000 dark:hover:bg-primaryDark-black cursor-pointer items-center"  >
                                           <a href="https://yard99.in/forms/finance"> <ps-label class="ms-2 text-secondary-500 font-medium"  > Finance </ps-label></a>                                        
                                        </div>

                                        <div class="w-56 py-4 px-2 hover:bg-primary-000 dark:hover:bg-primaryDark-black cursor-pointer items-center"  >
                                           <a href="https://yard99.in/forms/rto"> <ps-label class="ms-2 text-secondary-500 font-medium"  > RTO </ps-label></a>                                        
                                        </div>
            ...
            <transition @enter="enter" @leave="leave" >
                ...
                <div  class="flex flex-col " >
                    ...
                    <div v-else >
                        ...
                        <a href="https://yard99.in/forms/insurance"> <ps-label class="w-full hover:bg-primary-000 dark:hover:bg-primaryDark-black py-4 px-4 cursor-pointer"  > Insurance </ps-label></a>                                        
                        <a href="https://yard99.in/forms/finance"> <ps-label class="w-full hover:bg-primary-000 dark:hover:bg-primaryDark-black py-4 px-4 cursor-pointer"  > Finance </ps-label></a>                                        
                        <a href="https://yard99.in/forms/rto"> <ps-label class="w-full hover:bg-primary-000 dark:hover:bg-primaryDark-black py-4 px-4 cursor-pointer"  > RTO </ps-label></a>                                        
