...
export default defineComponent ({
    ...
    setup() {
        ...
        var supportedLanguages = reactive( [new Language] ) ;
        ...
        onMounted( async () =>{
            ...
            supportedLanguages.shift();
            supportedLanguages.push(...appInfoProvider.appInfo.data.frontendConfigSetting.excludeLanguage);
            supportedLanguages.push(appInfoProvider.appInfo.data.frontendConfigSetting.defaultLanguage);
        ...
        function getFlag(v){
            if(v == 'en'){
                ...
                require('@/assets/flags/italyFlag.jpg');
            }else if(v == 'ja'){
